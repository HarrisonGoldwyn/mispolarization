...
#         return pt_is_in_ellip
    ...
    def plot_mispol_map(self, plot_limits=None):
        ...
        quiv_ax, = quiver_plot(self.mol_locations[:,0], 
...
#     def plot_fit_results(self):
    def plot_fit_results_as_quiver_map(self, fitted_exp_instance, plot_limits=None):
        ...
        quiv_ax, = quiver_plot(fitted_exp_instance.mol_locations[:,0], 
                               ...
                               true_mol_angle=fitted_exp_instance.mol_angles, 
                               nanorod_angle = fitted_exp_instance.rod_angle,
                               title=r'Molel Fit Pol. and Loc. w/noise',)
        scatter_centroids_wLine(fitted_exp_instance.mol_locations[:,0], 
                                fitted_exp_instance.mol_locations[:,1],
                                self.model_fit_results[:,:2].T, quiv_ax)
        return quiv_ax
